...
function theme1787_random($length){
...
{ 
     ...
     if(1 != $pages)
     {
         ...
         if($paged > 1 && $showitems < $pages) echo "<a href='".get_pagenum_link($paged - 1)."'>Prev Page</a>";
         ...
         if ($paged < $pages && $showitems < $pages) echo "<a href=\"".get_pagenum_link($paged + 1)."\">Next Page</a>"; 

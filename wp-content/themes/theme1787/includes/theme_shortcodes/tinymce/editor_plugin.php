			...
			init: function(d,e) {
					...
					d.addCommand( "myThemeOpenDialog",function(a,c){
						...
						jQuery.get(e+"/dialog.php",function(b){
							...
							switch ( myThemeSelectedShortcodeType ) {
								...
								var a = '[top_content]'+selectedText+'[/top_content]';
								...
								var a = '[price_list]'+selectedText+'[/price_list]';
								...
								var a = '[pay_list]'+selectedText+'[/pay_list]';
				...
				createControl:function(d,e){
                  ...
                  c=b.addMenu({title:"HTML"});
										...
										a.addWithDialog(c,"Download Link","downloadlink");
										a.addWithDialog(c,"Drop Cap","dropcap");
										a.addWithDialog(c,"Extra Wrap","extrawrap");
										a.addWithDialog(c,"Blockquote","blockquote");
										a.addWithDialog(c,"Top Content","topcontent");
										a.addWithDialog(c,"Price List","pricelist");
										a.addWithDialog(c,"Pay List","paylist");
